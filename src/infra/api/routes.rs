...
use super::handlers::{
    ...
    statistics_handler::{AnalyticsHandler, StatisticsHandler},
    tournament_handler::{
...
pub fn api_routes(cfg: &mut web::ServiceConfig) {
    ...
    cfg.service(
        web::scope("/profile")
            ...
            .route(
                "/preferences",
                web::post().to(UserProfileHandler::update_preferences),
            )
            .route(
                "/notifications",
                web::post().to(UserProfileHandler::update_notification_preferences),
            )
            .route(
                "/privacy",
                web::post().to(UserProfileHandler::update_privacy_settings),
            )
            .route("/avatar", web::post().to(UserProfileHandler::update_avatar))
            .route(
                "/avatar",
                web::delete().to(UserProfileHandler::remove_avatar),
            )
            .route(
                "/{user_id}",
                web::get().to(UserProfileHandler::get_public_profile),
            ),
    );
    ...
    cfg.service(
        web::scope("/team_members")
            ...
            .route(
                "/team/{team_id}",
                web::get().to(TeamMemberHandler::get_by_team),
            )
            .route(
                "/player/{player_id}",
                web::get().to(TeamMemberHandler::get_by_player),
            )
            .route(
    ...
    cfg.service(
        web::scope("/tournaments")
            ...
            .route(
                "/status/{status}",
                web::get().to(TournamentHandler::get_by_status),
            )
            ...
            .route(
                "/templates",
                web::get().to(TournamentHandler::get_templates),
            )
            .route(
                "/templates/{template_id}",
                web::post().to(TournamentHandler::create_from_template),
            )
            ...
            .route(
                "/{id}/participants",
                web::get().to(TournamentHandler::get_participants),
            )
            .route("/{id}/export", web::get().to(TournamentHandler::export))
            .route(
                "/{id}/duplicate",
                web::post().to(TournamentHandler::duplicate),
            )
            .route(
                "/{id}/dashboard",
                web::get().to(TournamentHandler::get_dashboard),
            )
            .route(
                "/{id}/settings",
                web::put().to(TournamentHandler::update_settings),
            ),
    );
    ...
    cfg.service(
        web::scope("/tournament_categories")
            .route(
                "",
                web::post().to(TournamentCategoryHandler::create_category),
            )
            .route("/{id}", web::get().to(TournamentCategoryHandler::get_by_id))
            .route(
                "/tournament/{tournament_id}",
                web::get().to(TournamentCategoryHandler::get_by_tournament),
            )
    ...
    cfg.service(
        web::scope("/tournament_registrations")
            .route(
                "",
                web::post().to(TournamentRegistrationHandler::create_registration),
            )
            .route(
                "/{id}",
                web::get().to(TournamentRegistrationHandler::get_by_id),
            )
            .route(
                "/{id}",
                web::put().to(TournamentRegistrationHandler::update),
            )
            .route(
                "/{id}",
                web::delete().to(TournamentRegistrationHandler::delete),
            )
            .route(
                "/category/{category_id}",
                web::get().to(TournamentRegistrationHandler::get_by_category),
            )
            .route(
                "/tournament/{tournament_id}",
                web::get().to(TournamentRegistrationHandler::get_by_tournament),
            )
            .route(
                "/player/{player_id}",
                web::get().to(TournamentRegistrationHandler::get_by_player),
            )
            .route(
                "/team/{team_id}",
                web::get().to(TournamentRegistrationHandler::get_by_team),
            ),
    );
    ...
    cfg.service(
        web::scope("/brackets")
            .route(
                "/tournament/{tournament_id}",
                web::get().to(TournamentBracketHandler::get_brackets_by_tournament),
            )
            .route(
                "/category/{category_id}",
                web::get().to(TournamentBracketHandler::get_by_category),
            )
            .route(
                "/generate/{tournament_id}",
                web::put().to(TournamentBracketHandler::generate),
            ),
    );
    ...
    cfg.service(
        web::scope("/standings")
            .route(
                "/tournament/{tournament_id}",
                web::get().to(TournamentStandingsHandler::get_standings_by_tournament),
            )
            .route(
                "/category/{category_id}",
                web::get().to(TournamentStandingsHandler::get_by_category),
            )
            .route(
                "/update/{tournament_id}",
                web::put().to(TournamentStandingsHandler::update_standings),
            ),
    );
    ...
    cfg.service(
        web::scope("/matches")
            ...
            .route(
                "/tournament/{tournament_id}",
                web::get().to(MatchHandler::get_by_tournament),
            )
            .route(
                "/category/{category_id}",
                web::get().to(MatchHandler::get_by_category),
            )
            ...
            .route(
                "/{id}/participants",
                web::get().to(MatchHandler::get_participants),
            )
            ...
            .route(
                "/{id}/results/validate",
                web::get().to(MatchHandler::validate_result_scores),
            )
            .route("/{id}/live", web::put().to(MatchHandler::update_live))
            .route(
                "/{id}/analytics",
                web::get().to(MatchHandler::get_analytics),
            )
            .route(
                "/{id}/statistics",
                web::get().to(MatchHandler::get_statistics),
            )
            ...
            .route(
                "/{id}/subscribe",
                web::delete().to(MatchHandler::unsubscribe),
            ),
    );
    ...
    cfg.service(
        web::scope("/match-results")
            ...
            .route(
                "/match/{match_id}",
                web::get().to(MatchResultHandler::get_by_match),
            )
            .route(
                "/match/{match_id}/summary",
                web::get().to(MatchResultHandler::get_summary),
            )
            .route(
                "/match/{match_id}/count",
                web::get().to(MatchResultHandler::get_count),
            )
            .route(
                "/match/{match_id}",
                web::delete().to(MatchResultHandler::delete_all),
            )
            .route(
    ...
    cfg.service(
        web::scope("/notifications")
            ...
            .route(
                "/read-all",
                web::put().to(NotificationHandler::mark_all_read),
            )
    ...
    cfg.service(
        web::scope("/payments")
            ...
            .route(
                "/user/{user_id}",
                web::get().to(PaymentHandler::get_by_user),
            )
            .route(
                "/tournament/{tournament_id}",
                web::get().to(PaymentHandler::get_by_tournament),
            )
            ...
            .route(
                "/summary/tournament/{tournament_id}",
                web::get().to(PaymentHandler::get_tournament_summary),
            )
            .route(
                "/summary/user",
                web::get().to(PaymentHandler::get_user_summary),
            ),
    );
    ...
    cfg.service(
        web::scope("/stats")
            .route(
                "/player/{player_id}",
                web::get().to(StatisticsHandler::get_player_stats),
            )
            .route(
                "/team/{team_id}",
                web::get().to(StatisticsHandler::get_team_stats),
            )
            .route(
                "/tournament/{tournament_id}",
                web::get().to(StatisticsHandler::get_tournament_stats),
            )
            .route(
                "/leaderboard",
                web::get().to(StatisticsHandler::get_leaderboard),
            )
            .route(
                "/leaderboard/players",
                web::get().to(StatisticsHandler::get_leaderboard_players),
            )
            .route(
                "/leaderboard/players/wins",
                web::get().to(StatisticsHandler::get_leaderboard_players_wins),
            )
            .route(
                "/leaderboard/players/earnings",
                web::get().to(StatisticsHandler::get_leaderboard_players_earnings),
            )
            .route(
                "/leaderboard/teams",
                web::get().to(StatisticsHandler::get_leaderboard_teams),
            )
            .route("/records", web::get().to(StatisticsHandler::get_records))
            .route(
                "/summary",
                web::get().to(StatisticsHandler::get_platform_summary),
            )
            .route(
                "/my-stats",
                web::get().to(StatisticsHandler::get_my_player_statistics),
            ),
    );
