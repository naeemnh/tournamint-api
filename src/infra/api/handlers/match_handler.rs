...
use crate::application::MatchServices;
...
type MatchServicesData = std::sync::Arc<MatchServices<PgMatchRepository, PgMatchResultRepository>>;
...
impl MatchHandler {
    pub async fn post(
        services: web::Data<MatchServicesData>,
        body: web::Json<NewMatch>,
    ) -> HttpResponse {
        match services.create_match(body.into_inner()).await {
    ...
    pub async fn show(
        ...
        match services.get_match(id).await {
    ...
    pub async fn update(
        ...
        let id = path.into_inner();
        match services.update_match(id, body.into_inner()).await {
    ...
    pub async fn delete(
        ...
        let id = path.into_inner();
        match services.delete_match(id).await {
    ...
    pub async fn reschedule(
        ...
        let id = path.into_inner();
        match services.reschedule_match(id, body.into_inner()).await {
    ...
    pub async fn validate_result_scores(
        ...
        let id = path.into_inner();
        match services.validate_match_result_scores(id).await {
    ...
    pub async fn get_by_tournament(
        ...
        match services.get_matches_by_tournament(path.tournament_id).await {
    ...
    pub async fn get_by_category(
        ...
        match services.get_matches_by_category(path.category_id).await {
            Ok(matches) => ApiResponse::success("OK", Some(matches)),
            Err(e) => e.error_response(),
        }
    }
    ...
    pub async fn get_participants(
        ...
        let id = path.into_inner();
        match services.get_match_with_participants(id).await {
            Ok(Some(m)) => ApiResponse::success("OK", Some(m)),
            Ok(None) => ApiResponse::not_found("Match not found"),
            Err(e) => e.error_response(),
        }
    ...
    pub async fn update_status(
        ...
        let id = path.into_inner();
        match services.update_match_status(id, body.status).await {
            Ok(Some(m)) => {
    ...
    pub async fn start(
        ...
        let id = path.into_inner();
        match services.start_match(id).await {
            Ok(Some(m)) => {
                broadcaster
                    .broadcast_event(&RealtimeEvent::MatchUpdate {
                        match_id: m.id,
    ...
    pub async fn complete(
        ...
        let id = path.into_inner();
        match services
            .complete_match(id, body.winner_participant, body.is_draw)
            .await
        {
            Ok(Some(m)) => {
                broadcaster
    ...
    pub async fn cancel(
        ...
        match services.cancel_match(id, reason).await {
    ...
    pub async fn postpone(
        ...
        let id = path.into_inner();
        match services.postpone_match(id).await {
    ...
    pub async fn get_schedule(services: web::Data<MatchServicesData>) -> HttpResponse {
        match services.get_match_schedule().await {
    ...
    pub async fn my_upcoming(
        ...
        match services.get_user_upcoming_matches(user_id).await {
            Ok(items) => ApiResponse::success("OK", Some(items)),
            Err(e) => e.error_response(),
        }
    }
    ...
    pub async fn my_history(
        ...
        match services.get_user_match_history(user_id).await {
            Ok(items) => ApiResponse::success("OK", Some(items)),
            Err(e) => e.error_response(),
        }
    }

    pub async fn get_live(services: web::Data<MatchServicesData>) -> HttpResponse {
        match services.get_live_matches().await {
            Ok(matches) => ApiResponse::success("OK", Some(matches)),
            Err(e) => e.error_response(),
        }
    }
    ...
    pub async fn update_live(
        ...
        let id = path.into_inner();
        match services.update_live_match(id, body.into_inner()).await {
            Ok(Some(m)) => {
                broadcaster
                    .broadcast_event(&RealtimeEvent::MatchUpdate {
                        match_id: m.id,
    ...
    pub async fn get_analytics(
        ...
        let id = path.into_inner();
        match services.get_match_analytics(id).await {
    ...
    pub async fn get_statistics(
        ...
        let id = path.into_inner();
        match services.get_match_statistics(id).await {
    ...
    pub async fn get_media(
        ...
        let id = path.into_inner();
        match services.get_match_media(id).await {
    ...
    pub async fn get_comments(
        ...
        let id = path.into_inner();
        match services.get_match_comments(id).await {
    ...
    pub async fn add_comment(
        ...
        let id = path.into_inner();
        match services.add_match_comment(id, user_id, &body.comment).await {
    ...
    pub async fn subscribe(
        ...
        let id = path.into_inner();
        match services.subscribe_to_match(id, user_id).await {
    ...
    pub async fn unsubscribe(
        ...
        let id = path.into_inner();
        match services.unsubscribe_from_match(id, user_id).await {
...
impl MatchResultHandler {
    pub async fn post(
        ...
        match services.create_match_result(body.into_inner()).await {
    ...
    pub async fn show(
        ...
        let id = path.into_inner();
        match services.get_match_result(id).await {
    ...
    pub async fn update(
        ...
        let id = path.into_inner();
        match services.update_match_result(id, body.into_inner()).await {
    ...
    pub async fn bulk_post(
        ...
        match services.bulk_create_match_results(body.into_inner()).await {
    ...
    pub async fn delete(
        ...
        let id = path.into_inner();
        match services.delete_match_result(id).await {
            Ok(Some(_)) => ApiResponse::success("Deleted", Some(serde_json::json!({}))),
            Ok(None) => ApiResponse::not_found("Match result not found"),
            Err(e) => e.error_response(),
        }
    ...
    pub async fn get_by_match(
        ...
        match services.get_match_results(path.match_id).await {
    ...
    pub async fn get_summary(
        ...
        match services.get_match_score_summary(path.match_id).await {
    ...
    pub async fn get_count(
        ...
        match services.count_match_results(path.match_id).await {
    ...
    pub async fn delete_all(
        ...
        match services.delete_all_match_results(path.match_id).await {
            Ok(count) => {
                ApiResponse::success("Deleted", Some(serde_json::json!({ "deleted": count })))
            }
            Err(e) => e.error_response(),
        }
    }
