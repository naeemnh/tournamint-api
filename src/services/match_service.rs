...
use crate::models::match_model::{
    Match, CreateMatchRequest, UpdateMatchRequest, UpdateMatchStatusRequest,
    MatchWithParticipants, CompleteMatchRequest, CancelMatchRequest,
    PostponeMatchRequest, RescheduleMatchRequest, LiveMatchUpdate,
    MatchComment, AddMatchCommentRequest, MatchSubscription,
    SubscribeToMatchRequest, BulkUpdateMatchesRequest, BulkCancelMatchesRequest,
    MatchAnalytics, MatchStatistics, MatchMedia, UploadMatchMediaRequest,
};
...
impl MatchService {
    ...
    pub async fn get_match_with_participants(&self, match_id: Uuid) -> Result<Option<MatchWithParticipants>> {
    ...
    pub async fn complete_match(&self, match_id: Uuid, request: CompleteMatchRequest) -> Result<Match> {
        self.match_repository.complete_match(match_id, request).await
    }
    ...
    pub async fn postpone_match(&self, match_id: Uuid, request: PostponeMatchRequest) -> Result<Match> {
        self.match_repository.postpone_match(match_id, request).await
    }

    pub async fn get_user_upcoming_matches(&self, user_id: Uuid) -> Result<Vec<Match>> {
        self.match_repository.find_user_upcoming_matches(user_id).await
    }
    ...
    pub async fn reschedule_match(&self, match_id: Uuid, request: RescheduleMatchRequest) -> Result<Match> {
        self.match_repository.reschedule_match(match_id, request).await
    }
    ...
    pub async fn update_live_match(&self, match_id: Uuid, update: LiveMatchUpdate) -> Result<Match> {
        self.match_repository.update_live_match(match_id, update).await
    }
    ...
    pub async fn upload_match_media(&self, match_id: Uuid, user_id: Uuid, request: UploadMatchMediaRequest) -> Result<MatchMedia> {
        self.match_repository.upload_match_media(match_id, user_id, request).await
    }
    ...
    pub async fn add_match_comment(&self, match_id: Uuid, user_id: Uuid, request: AddMatchCommentRequest) -> Result<MatchComment> {
        self.match_repository.add_match_comment(match_id, user_id, request).await
    }

    pub async fn subscribe_to_match(&self, match_id: Uuid, user_id: Uuid, request: SubscribeToMatchRequest) -> Result<MatchSubscription> {
        self.match_repository.subscribe_to_match(match_id, user_id, request).await
    }

    pub async fn unsubscribe_from_match(&self, match_id: Uuid, user_id: Uuid) -> Result<()> {
        self.match_repository.unsubscribe_from_match(match_id, user_id).await
    }
