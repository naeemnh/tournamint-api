...
CREATE INDEX idx_matches_participant1_team ON matches (participant1_team_id)
WHERE
    participant1_team_id IS NOT NULL;

CREATE INDEX idx_matches_participant2_team ON matches (participant2_team_id)
WHERE
    participant2_team_id IS NOT NULL;

CREATE INDEX idx_matches_participant1_player ON matches (participant1_player_id)
WHERE
    participant1_player_id IS NOT NULL;

CREATE INDEX idx_matches_participant2_player ON matches (participant2_player_id)
WHERE
    participant2_player_id IS NOT NULL;